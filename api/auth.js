...
//退出登录
export const logout = data => http.post('/app-api/member/auth/logout', data)

// 发送手机验证码
export const getSmsCode = data => http.post('/app-api/member/auth/send-sms-code', data)
// 使用手机和验证码登录
export const smsLogin = data => http.post('/app-api/member/auth/sms-login', data)